...
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1, '华为', NULL, 'HUAWEI', 1, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1442 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品三级分类' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_category` VALUES (166, '网络原创', 22, 3, 1, 2, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (167, '数字杂志', 22, 3, 1, 3, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (1433, '试试', 1, 2, 1, 0, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1434, '再试试', 1433, 3, 1, 3, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1435, '试试就试试', 1433, 3, 0, 4, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1436, '再试一次', 1433, 3, 0, 5, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1437, '搞一个试试', 1433, 3, 1, 0, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1438, '在搞一个试试', 1433, 3, 0, 6, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1439, '搞了很多个了', 1433, 3, 1, 1, NULL, NULL, NULL);
INSERT INTO `pms_category` VALUES (1440, '整一整二', 1, 2, 0, 0, NULL, '个', NULL);
INSERT INTO `pms_category` VALUES (1441, '整一整二整三', 1433, 3, 1, 2, NULL, '粒', NULL);

-- ----------------------------
-- Table structure for pms_category2
-- ----------------------------
DROP TABLE IF EXISTS `pms_category2`;
CREATE TABLE `pms_category2`  (
  `cat_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分类名称',
  `parent_cid` bigint(20) NULL DEFAULT NULL COMMENT '父分类id',
  `cat_level` int(11) NULL DEFAULT NULL COMMENT '层级',
  ...
  `product_count` int(11) NULL DEFAULT NULL COMMENT '商品数量',
  PRIMARY KEY (`cat_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品三级分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category2
-- ----------------------------
INSERT INTO `pms_category2` VALUES (1, '图书、音像、电子书刊', 0, 1, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category2` VALUES (21, '整车', 0, 1, 1, 0, NULL, NULL, 0);
